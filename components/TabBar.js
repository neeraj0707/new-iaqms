  ...
  return (
    <View style={styles.tabbar}>
      {state.routes.map((route, index) => {
        ...
        if (['fetch_data','map', 'shop.js', '_sitemap', '+not-found', 'aqi_details', 'details_screen', 'syncData', 'GraphScreen','LiveDataGraph','HistoricalDataGraph','HistoryData','WeatherForecast','HIstogram','pastData','Histogram','HistoricalData','health_advisory','AQIListener','detail','firebase','syncDataToFirestore','SendPushNotification','registerForPushNotifications'].includes(route.name)) return null;
